 ...
 **/
 ...
 housesArray = [
    ...
    },
    {
        ...
        text: "Slytherpuffs are the 'good Slytherins,' if you will. They are ambitious and they have deeply rooted morals that keep them grounded. They use that resourcefulness and ambition to help others, do good things, and spread kindness. They would be the kind of people that start non-profits (if wizards have non-profits, that is). They are some of the best kind of people. I could definitely see them palling around with Grufflepuffs."
     }
]
...
function sortingHatHash(str) {
  ...
  var myButton = $("#button");
//var myButton = document.getElementById("button"); (This is JS, top is jQuery)
  $("#button").click(function(){
//myButton.addEventListener("click", function() {
  // get value from input field
  var name = $("#input:text").val();
//var name = document.getElementById("input").value; (This is JS, top is jQuery)
  ...
  $("#output").html(newText);
//document.getElementById("output").innerHTML = newText; (This is JS, top is jQuery)
})
